...
const Video = () => {
  ...
  return (
    <div className='w-[71.5%] py-8 flex flex-col h-fit'>
      ...
      <div className='flex flex-row gap-x-2'>
        ...
        <div className='w-4/12 max-h-[400px] overflow-y-auto bg-gray-200'>
          {videos.slice(0, 10).map((listVideo) => (
            ...
            >
              <img src={listVideo.imgVideo} alt="" className='h-1/6 w-2/5' />
