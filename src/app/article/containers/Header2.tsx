...
const Header = () => {
    ...
    return (
        <>
            <div className={`w-full h-16 flex flex-col items-center shadow-[-10px_-10px_0px_rgba(0,0,0,0.3)]  bg-white z-50 transition-all duration-1000 ${Scrolled ? 'fixed top-0 z-30': 'absolute -top-16 z-30'}`}>
