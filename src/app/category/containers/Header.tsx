...
const Header = () => {
    ...
    return (
        <>
            <div className={`w-full h-16 flex flex-col items-center justify-center shadow-[-10px_-10px_0px_rgba(0,0,0,0.3)] fixed top-0 bg-white z-50 border border-b-gray-200`}>
